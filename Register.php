...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  if ($verifypassword == $mypassword) {
    $sql = "INSERT INTO `Customer` (`Email`, `Name`, `Password`) VALUES ('$myusername', '$myName', '$myPassword')";
  ...
  <div class="cover-containter">
    ...
    <main class="row">
      ...
      <form class="form-signin col-4" action="" method="post">
        ...
        <input type="string" id="Name"  name="Name"class="form-control" placeholder="Name" required="" autofocus="">
